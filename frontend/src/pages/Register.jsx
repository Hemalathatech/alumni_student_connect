...
import { User, Mail, Lock, Building, GraduationCap, AlertCircle } from 'lucide-react';
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    type="text"
                                    required
                                    className="appearance-none rounded-t-lg relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
